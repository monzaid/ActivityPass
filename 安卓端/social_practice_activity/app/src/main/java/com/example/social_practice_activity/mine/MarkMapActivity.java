...
public class MarkMapActivity extends AppCompatActivity implements AMapLocationListener, LocationSource, PoiSearch.OnPoiSearchListener {
...
//    private boolean isFirstLoc = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(MarkMapActivity.this, "点击地图来设置签到位置", Toast.LENGTH_SHORT).show();
...
//        tv = findViewById(R.id.tv_place);
        mapView = findViewById(R.id.map_view);
        mapView.onCreate(savedInstanceState);
        fabPOI = findViewById(R.id.fab);
        fabPOI.setImageResource(R.mipmap.save);
        ...
        //构造 GeocodeSearch 对象
        geocodeSearch = new GeocodeSearch(MarkMapActivity.this);
...
//                tv.setText(address == null ? "无地址" : address);
                ...
                marker = aMap.addMarker(new MarkerOptions().position(new LatLng(distance_y, distance_x)).snippet("DefaultMarker"));
...
//                }
    ...
    public void queryPOI(View view) {
        ...
        System.out.println("aaa" + distance_y + " " + distance_x);
