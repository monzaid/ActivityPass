package com.example.social_practice_activity.myView;
...
public class UpdataListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public UpdataListView(Context context) {
        this(context,null);
    }

    public UpdataListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void initHeaderView() {
        headerView = View.inflate(getContext(), R.layout.updatalistview_header_layout, null);
        iv_arrow = (ImageView) headerView.findViewById(R.id.arrow);
        pb_rotate = (ProgressBar) headerView.findViewById(R.id.progress);
        tv_state = (TextView) headerView.findViewById(R.id.tips);
    ...
    private void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.updatalistview_footer_loyout, null);
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        if(scrollState==OnScrollListener.SCROLL_STATE_IDLE
            ...
            TextView tips = (TextView)footerView.findViewById(R.id.tips);
            ProgressBar progress = (ProgressBar)footerView.findViewById(R.id.progress);
            tips.setText("正在加载中");
