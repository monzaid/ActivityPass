...
public class UpdataListViewAdaper extends BaseAdapter {

    private List<myActivity> list;
    private ListView listview;
    private LruCache<String, BitmapDrawable> mImageCache;

    public UpdataListViewAdaper(List<myActivity> list) {
        super();
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.title.setText(myActivity.title);
        holder.introduction.setText(myActivity.introduction);
        holder.iv.setTag(myActivity.image);
        holder.place.setText(myActivity.place);
        holder.time.setText(myActivity.getStart_time());
        holder.people.setText(String.valueOf(myActivity.people));
    ...
    class ViewHolder {
        ImageView iv;
        TextView title, introduction, place, time, people;
    }
