...
public class ActivityJoinList extends AppCompatActivity implements UpdataListView.OnRefreshListener{
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case INITDATA_TEXT:
                    ...
                    updateListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent intent = new Intent(ActivityJoinList.this, ActivityDetail.class);
                ...
                case UPDATE_TEXT:
                    ...
                    break;
                case UNUPDATE_TEXT:
                    Toast.makeText(ActivityJoinList.this, "没有更多了", Toast.LENGTH_SHORT).show();
                    break;
                case FAIL_TEXT:
                    Toast.makeText(ActivityJoinList.this, "网络错误", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
